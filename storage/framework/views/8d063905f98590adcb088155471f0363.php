  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo e(url('/dashboard')); ?>" class="site_title"><i class="fa fa-paw"></i> <span>Alumni System</span></a>
            </div>

            <div class="clearfix"></div>

            <!-- menu profile quick info -->
            <?php echo $__env->make('panel.includes.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <!-- /menu profile quick info -->

            <br />

            <!-- sidebar menu -->
            <?php echo $__env->make('panel.includes.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <!-- /sidebar menu -->
        ...
        <div class="top_nav">
            <div class="nav_menu">
                <?php echo $__env->make('panel.includes.top_nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        <!-- page content -->
        ...
        <!-- footer content -->
        <footer>
          <?php echo $__env->make('panel.includes.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
      </div>
...
<?php /**PATH C:\xampp\htdocs\alumni-management\resources\views/panel/layout.blade.php ENDPATH**/ ?>