...
<body>
    ...
    <section class="hero-banner">
        <div class="container">
            ...
            <div>
                @auth
                    <a href="{{ route('dashboard') }}" class="btn btn-lg btn-gentle-success"><i class="fa fa-dashboard m-right-xs"></i> Go to Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="btn btn-lg btn-gentle-success" style="margin-right: 10px;"><i class="fa fa-sign-in m-right-xs"></i> Sign In</a>
                    <a href="{{ route('register') }}" class="btn btn-lg btn-gentle-outline"><i class="fa fa-edit m-right-xs"></i> Join Network</a>
                @endauth
            </div>
        </div>
    </section>
