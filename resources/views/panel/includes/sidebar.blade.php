...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li>
        <a href="{{ url('/events') }}"><i class="fa fa-calendar"></i> Events List</a>
      </li>
    </ul>
  </div>
    ...
    <ul class="nav side-menu">
      <li><a><i class="fa fa-users"></i> Alumni Control <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ url('/admin/approvals') }}">Pending Approvals</a></li>
  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      <li>
        <a href="{{ url('/my-invoices') }}"><i class="fa fa-credit-card"></i> My Bills & Fees</a>
      </li>
